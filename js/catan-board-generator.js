...
var _ComponentDataManager = __webpack_require__(20);

var _ComponentDataManager2 = _interopRequireDefault(_ComponentDataManager);

var _ComponentRegistry = __webpack_require__(50);
...
var _domNamed = __webpack_require__(44);
...
var _metalState = __webpack_require__(4);

var _metalIncrementalDom = __webpack_require__(22);

var _metalIncrementalDom2 = _interopRequireDefault(_metalIncrementalDom);

var _SoyAop = __webpack_require__(61);
...
var _domData = __webpack_require__(10);

var _domData2 = _interopRequireDefault(_domData);

var _DomEventEmitterProxy = __webpack_require__(46);

var _DomEventEmitterProxy2 = _interopRequireDefault(_DomEventEmitterProxy);

var _DomEventHandle = __webpack_require__(18);
...
var _globalEval = __webpack_require__(47);

var _globalEval2 = _interopRequireDefault(_globalEval);

var _globalEvalStyles = __webpack_require__(48);
...
var _IncrementalDomRenderer = __webpack_require__(55);
...
var _unused = __webpack_require__(60);
...
exports.CatanBoardGenerator = undefined;
...
var _CatanBoardGeneratorSoy = __webpack_require__(62);

var _CatanBoardGeneratorSoy2 = _interopRequireDefault(_CatanBoardGeneratorSoy);
...
var CatanBoardGenerator = function (_Component) {
    _inherits(CatanBoardGenerator, _Component);

    function CatanBoardGenerator() {
        _classCallCheck(this, CatanBoardGenerator);

        return _possibleConstructorReturn(this, (CatanBoardGenerator.__proto__ || Object.getPrototypeOf(CatanBoardGenerator)).apply(this, arguments));
    }

    _createClass(CatanBoardGenerator, [{
        key: '_handleShipSelectedMaterialChange',
        value: function _handleShipSelectedMaterialChange(event, facade) {
            var id = facade.target.id;
        ...
        key: '_handleTileSelectedProbabilityChange',
        value: function _handleTileSelectedProbabilityChange(event, facade) {
            var id = facade.target.id;
            var value = event.delegateTarget.value;
        ...
        key: '_handleTileSelectedTypeChange',
        value: function _handleTileSelectedTypeChange(event, facade) {
            var id = facade.target.id;
            var value = event.delegateTarget.value;
...
CatanBoardGenerator.STATE = {
    ships: _metalState.Config.array().value([]),

    tiles: _metalState.Config.object().value({})
};

_metalSoy2.default.register(CatanBoardGenerator, _CatanBoardGeneratorSoy2.default);

exports.CatanBoardGenerator = CatanBoardGenerator;
exports.default = CatanBoardGenerator;
...
var _sync = __webpack_require__(43);
...
var _DomDelegatedEventHandle = __webpack_require__(45);
...
var _HTMLParser = __webpack_require__(53);
...
var _patch2 = __webpack_require__(58);
...
exports.templates = exports.CatanBoardGenerator = undefined;
...
goog.loadModule(function (exports) {
  ...
  var $templateAlias1 = _metalSoy2.default.getTemplate('LandTile.incrementaldom', 'render');

  var $templateAlias2 = _metalSoy2.default.getTemplate('Ship.incrementaldom', 'render');
...
_metalSoy2.default.register(CatanBoardGenerator, templates);
exports.CatanBoardGenerator = CatanBoardGenerator;
...
var _LandTileSoy = __webpack_require__(64);

var _LandTileSoy2 = _interopRequireDefault(_LandTileSoy);
...
var LandTile = function (_Component) {
    _inherits(LandTile, _Component);

    function LandTile() {
        _classCallCheck(this, LandTile);

        return _possibleConstructorReturn(this, (LandTile.__proto__ || Object.getPrototypeOf(LandTile)).apply(this, arguments));
    }

    _createClass(LandTile, [{
        key: '_handleProbabilityChange',
        value: function _handleProbabilityChange(event) {
            this.emit('selectedProbabilityChanged', event);
        }
    }, {
        key: '_handleTypeChange',
        value: function _handleTypeChange(event) {
...
LandTile.STATE = {
    eligible: _metalState.Config.bool().value(false),

    id: _metalState.Config.string().required(),

    probability: _metalState.Config.number(),

    type: _metalState.Config.oneOf(['desert', 'fields', 'forest', 'hills', 'mountains', 'pasture'])
};

_metalSoy2.default.register(LandTile, _LandTileSoy2.default);

exports.LandTile = LandTile;
exports.default = LandTile;
...
exports.templates = exports.LandTile = undefined;
...
goog.loadModule(function (exports) {
  ...
  function $render(opt_data, opt_ijData, opt_ijData_deprecated) {
    ...
    var tileAttributes__soy100 = function tileAttributes__soy100() {
...
_metalSoy2.default.register(LandTile, templates);
exports.LandTile = LandTile;
exports.templates = templates;
exports.default = templates;
/* jshint ignore:end */
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/lib/loader.js!./land-tile.scss", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/lib/loader.js!./land-tile.scss");
...
var _ShipSoy = __webpack_require__(69);

var _ShipSoy2 = _interopRequireDefault(_ShipSoy);
...
var Ship = function (_Component) {
    _inherits(Ship, _Component);

    function Ship() {
        _classCallCheck(this, Ship);

        return _possibleConstructorReturn(this, (Ship.__proto__ || Object.getPrototypeOf(Ship)).apply(this, arguments));
    }

    _createClass(Ship, [{
        key: '_handleMaterialChange',
        value: function _handleMaterialChange(event) {
...
Ship.STATE = {
    ...
    material: _metalState.Config.oneOf(['any', 'brick', 'grain', 'lumber', 'ore', 'wool'])
};

_metalSoy2.default.register(Ship, _ShipSoy2.default);
...
exports.templates = exports.Ship = undefined;
...
_metalSoy2.default.register(Ship, templates);
exports.Ship = Ship;
exports.templates = templates;
exports.default = templates;
/* jshint ignore:end */
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/lib/loader.js!./ship.scss", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/lib/loader.js!./ship.scss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
// module
exports.push([module.i, ".ship {\n  background-size: 100%;\n  height: 60px;\n  width: 60px; }\n  .ship select {\n    position: absolute;\n    z-index: 10; }\n    @media print {\n      .ship select {\n        display: none; } }\n  .ship span {\n    background-size: 100%;\n    display: block;\n    height: 60px;\n    width: 60px; }\n  .ship .any {\n    background-image: url(\"/images/ship-any.png\"); }\n  .ship .brick {\n    background-image: url(\"/images/ship-brick.png\"); }\n  .ship .lumber {\n    background-image: url(\"/images/ship-lumber.png\"); }\n  .ship .ore {\n    background-image: url(\"/images/ship-ore.png\"); }\n  .ship .sheep {\n    background-image: url(\"/images/ship-sheep.png\"); }\n  .ship .wheat {\n    background-image: url(\"/images/ship-wheat.png\"); }\n", ""]);
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../node_modules/css-loader/index.js!../node_modules/sass-loader/lib/loader.js!./catan-board-generator.scss", function() {
			var newContent = require("!!../node_modules/css-loader/index.js!../node_modules/sass-loader/lib/loader.js!./catan-board-generator.scss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
